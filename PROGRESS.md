...
- [x] **Plan 5b — Scénario en direct** : curseurs/menus/cases sur ⑦ (20 champs), recalcul live ①④⑤⑥⑦⑧, score/100 automatique (rendement net-net/cash-on-cash/TRI, sans pondération utilisateur), autosave débouncée ~600ms, 2/3 dettes du Plan 5a corrigées. **Validé sur Vercel le 2026-07-26.**
- [x] **Plan 5c — Photos & Documents** : upload glisser-déposer avec compression image transparente (`browser-image-compression`), grille photos réorganisable (`@dnd-kit/sortable`) + légende + lightbox plein écran, liste documents typés + téléchargement, limites 8 Mo/20 photos/10 documents calculées contre le quota gratuit Supabase. **Validé sur Vercel le 2026-07-26.**
...
- **Validé par l'utilisateur sur Vercel** (« c'est bon », Plans 5b et 5c ensemble) → les deux cochés le 2026-07-26.
- **Prochaine action** : brainstorm Plan 6 (vue Carte) ou Plan 7 (Comparer/Arbitrage), au choix de l'utilisateur.
