...
- [x] **Step 2: Écrire les types partagés**
...
- [x] **Step 3: Vérification manuelle des seuils (pas de framework de test → petit script jetable)**
...
- [x] **Step 3: Vérification manuelle rapide**
